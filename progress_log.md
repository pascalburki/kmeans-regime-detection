...
Key finding: hypothesized disagreement days would show elevated correlation (tying to the Regime Instability project's stress finding). Mean correlation for disagreements was 0.7073 vs 0.9125 overall, mean vol for disagreements was 0.0057 vs 0.0108 overall, both lower than average, the opposite of the hypothesis. Correlation adds a genuinely separate axis of information beyond volatility, not just a confirmation of it
